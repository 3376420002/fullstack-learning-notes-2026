...
| 05 | [TypeScript](./学习文档/05-TypeScript基础与类型系统.md) | 类型收窄、泛型、API 契约 | ✅ |
...
| 09 | [Axios 与前后端接口层](./学习文档/09-Axios与前后端接口层.md) | 请求封装、错误模型、认证、取消上传 | ✅ |
...
全部课程保持适中深度：先讲理解技术所需的基础，再用真实项目代码说明，最后连接到 AI 编程和面试表达。

```text
技术用途 → 必要基础 → 常用代码 → 项目边界 → 常见错误 → AI 编程指令 → 面试表达
```

建议从 [MVC 分层架构](./学习文档/01-MVC分层架构.md) 开始，重点建立技术之间的联系、读懂项目代码，并学会准确地指挥 AI 完成开发任务。文档不设置练习题和作业，适合顺序学习，也适合开发或面试前快速复习。
